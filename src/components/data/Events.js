...
export default function EventsFolder() {
  const eventsData = [
    ...
    { name: "Dual Wield", img_src: sample_src },
    { name: "Side Quest", img_src: sample_src },
    { name: "GD", img_src: sample_src },
    { name: "Audio Engineering", img_src: sample_src },
    { name: "AI/ML Workshop", img_src: sample_src },
