...
export default function Designathon() {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>A/V Editing</strong> - Aniket Kumar and Chirag Sehgal
        </li>
        <li>
          <strong>Design</strong> - Gayatri
        </li>
        <li>
          <strong>Pitching</strong> - Puranjay Chawla
        </li>
      </ul>
      <p>The event will take place in 2 stages</p>
      <h3>Stage 1</h3>
      <p>
        Participants will be given a fictional event description and will be
      ...
      <ul>
        <li>
          <p>
            ...
            <strong>text file</strong> accrediting the chosen clips/music/sound
            effects
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Task 3:</strong> To submit a <strong>design guide</strong>{" "}
            explaining their design scheme, and elaborate on the same under 10
            minutes.
            <br />
            <strong>Format: .ppt</strong> or <strong>.pdf</strong>
          </p>
        </li>
      </ul>
      <h3>Stage 2</h3>
      <p>
        Participants will be given a topic on the spot, based on which they will
        have to complete the following tasks:
      </p>
      <ul>
        <li>
          <p>
